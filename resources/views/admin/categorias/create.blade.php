                    ...
                    <form method="POST" action="{{ route('categorias.store') }}">
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <input type="text" id="nome" name="nome" class="block w-full p-2.5 rounded-lg border-transparent bg-gray-100 dark:bg-gray-900 focus:ring-2 focus:ring-blue-500" placeholder="Ex: Salário, Supermercado" required value="{{ old('nome') }}">
                                @error('nome')
                            ...
                            <div>
                                ...
                                <div class="grid grid-cols-2 gap-4">
                                    <div>
                                        <input type="radio" id="tipo-receita" name="tipo" value="receita" class="hidden peer" {{ old('tipo', 'despesa') == 'receita' ? 'checked' : '' }}>
                                    ...
                                    <div>
                                        <input type="radio" id="tipo-despesa" name="tipo" value="despesa" class="hidden peer" {{ old('tipo', 'despesa') == 'despesa' ? 'checked' : '' }}>
