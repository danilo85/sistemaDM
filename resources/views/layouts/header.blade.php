                ...
                @can('acessar_financeiro')
                    <div class="relative">
                        <button @click="toggleDropdown('financeiro')" 
                                class="px-4 py-2 rounded-lg text-sm font-medium transition-all duration-200 hover:bg-gray-100 dark:hover:bg-gray-800 flex items-center space-x-1 {{ request()->routeIs(['transacoes.*', 'categorias.*', 'bancos.*']) ? 'bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300' : 'text-gray-700 dark:text-gray-300' }}">
