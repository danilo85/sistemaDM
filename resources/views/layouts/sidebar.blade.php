...
>
    ...
    <div class="flex items-center justify-between">
        <a href="{{ route('dashboard') }}" x-show="!sidebarCollapsed || isMobile" class="focus:outline-none focus:ring-2 focus:ring-indigo-500 rounded">
        ...
        {{-- Toggle: Desktop alterna colapso; Mobile fecha --}}
        <button
    ...
    <div class="mt-6 flex flex-1 flex-col justify-between">
        <nav class="-mx-3 space-y-6" role="navigation">
            ...
            <div class="space-y-2">
                <a
                    class="{{ $linkBase }} {{ request()->routeIs('dashboard') ? $activeBg : '' }}"
                ...
                @can('acessar_orcamentos')
                    <a
                        class="{{ $linkBase }} {{ request()->routeIs('orcamentos.*') ? $activeBg : '' }}"
                        :class="(sidebarCollapsed && !isMobile) ? 'px-2 py-3 justify-center' : 'px-3 py-2'"
            ...
            @if (auth()->user()->can('acessar_clientes') || auth()->user()->can('acessar_autores') || auth()->user()->can('gerenciar_usuarios'))
                <div class="space-y-2 border-t border-gray-200 dark:border-gray-700 pt-4">
                    ...
                    @can('gerenciar_usuarios')
                        <a
                            class="{{ $linkBase }} {{ request()->routeIs('admin.users.*') ? $activeBg : '' }}"
                            :class="(sidebarCollapsed && !isMobile) ? 'px-2 py-3 justify-center' : 'px-3 py-2'"
                    ...
                    @can('acessar_clientes')
                        <a
                            class="{{ $linkBase }} {{ request()->routeIs('clientes.*') ? $activeBg : '' }}"
                            :class="(sidebarCollapsed && !isMobile) ? 'px-2 py-3 justify-center' : 'px-3 py-2'"
                    ...
                    @can('acessar_autores')
                        <a
                            class="{{ $linkBase }} {{ request()->routeIs('autores.*') ? $activeBg : '' }}"
                            :class="(sidebarCollapsed && !isMobile) ? 'px-2 py-3 justify-center' : 'px-3 py-2'"
            ...
            <div class="space-y-2 border-t border-gray-200 dark:border-gray-700 pt-4">
                ...
                @can('acessar_clientes')
                    ...
                    <a class="flex items-center rounded-lg text-gray-600 transition-colors duration-300 hover:bg-gray-100 hover:text-gray-700 dark:text-gray-200 dark:hover:bg-gray-700 {{ request()->routeIs('portfolio.pipeline.index') ? 'bg-gray-100 dark:bg-gray-700' : '' }}" 
                    ...
                    <a class="flex items-center rounded-lg text-gray-600 transition-colors duration-300 hover:bg-gray-100 hover:text-gray-700 dark:text-gray-200 dark:hover:bg-gray-700 {{ request()->routeIs('portfolio.categories.index') ? 'bg-gray-100 dark:bg-gray-700' : '' }}" 
                    :class="(sidebarCollapsed && !isMobile) ? 'p-3 justify-center' : 'p-2'" 
            ...
            @can('acessar_financeiro')
                <div class="space-y-2 border-t border-gray-200 dark:border-gray-700 pt-4">
                    ...
                    <a class="{{ $linkBase }} {{ request()->routeIs('transacoes.*') ? $activeBg : '' }}"
                       :class="(sidebarCollapsed && !isMobile) ? 'px-2 py-3 justify-center' : 'px-3 py-2'"
                    ...
                    <a class="{{ $linkBase }} {{ request()->routeIs('categorias.*') ? $activeBg : '' }}"
                       :class="(sidebarCollapsed && !isMobile) ? 'px-2 py-3 justify-center' : 'px-3 py-2'"
                    ...
                    <a class="{{ $linkBase }} {{ request()->routeIs('bancos.*') ? $activeBg : '' }}"
                       :class="(sidebarCollapsed && !isMobile) ? 'px-2 py-3 justify-center' : 'px-3 py-2'"
                    ...
                    <a class="{{ $linkBase }} {{ request()->routeIs('cartoes.*') ? $activeBg : '' }}"
                       :class="(sidebarCollapsed && !isMobile) ? 'px-2 py-3 justify-center' : 'px-3 py-2'"
        ...
        <div class="space-y-2 border-t border-gray-200 dark:border-gray-700 pt-4">
            ...
            <a
                class="{{ $linkBase }} {{ request()->routeIs('profile.*') ? $activeBg : '' }}"
                :class="(sidebarCollapsed && !isMobile) ? 'px-2 py-3 justify-center' : 'px-3 py-2'"
