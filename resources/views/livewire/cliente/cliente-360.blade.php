<div>
    {{-- Header com Nome do Cliente e Ações Rápidas --}}
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow mb-6">
        <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
            <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                {{-- Nome do Cliente e Tags --}}
                <div class="flex items-center gap-3">
                    ...
                    <div class="flex-1">
                        <div class="flex items-center gap-3">
                            ...
                            {{-- Dropdown para mobile alinhado ao nome --}}
                ...
                <div class="bg-gradient-to-r from-blue-500 to-blue-600 rounded-lg p-4 text-white">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-2xl font-bold">{{ $orcamentosEnviados }}</p>
                        </div>
                ...
                <div class="bg-gradient-to-r from-green-500 to-green-600 rounded-lg p-4 text-white">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-2xl font-bold">{{ number_format($taxaAprovacao, 1) }}%</p>
                        </div>
                ...
                <div class="bg-gradient-to-r from-purple-500 to-purple-600 rounded-lg p-4 text-white">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-2xl font-bold">R$ {{ number_format($totalEmProjetos, 2, ',', '.') }}</p>
                        </div>
                ...
                <div class="bg-gradient-to-r from-orange-500 to-orange-600 rounded-lg p-4 text-white">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-2xl font-bold">R$ {{ number_format($saldoDevedor, 2, ',', '.') }}</p>
                        </div>
    ...
    {{-- Sistema de Abas com Flowbite --}}
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow">
        {{-- Navegação das Abas --}}
        <div class="border-b border-gray-200 dark:border-gray-700">
            <nav class="-mb-px flex space-x-8 px-6" aria-label="Tabs">
                <button wire:click="setActiveTab('visao-geral')" 
                        class="{{ $activeTab === 'visao-geral' ? 'border-indigo-500 text-indigo-600 dark:text-indigo-400' : 'border-transparent text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300 hover:border-gray-300 dark:hover:border-gray-600' }} whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm">
                ...
                <button wire:click="setActiveTab('orcamentos')" 
                        class="{{ $activeTab === 'orcamentos' ? 'border-indigo-500 text-indigo-600 dark:text-indigo-400' : 'border-transparent text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300 hover:border-gray-300 dark:hover:border-gray-600' }} whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm">
                    <svg class="w-5 h-5 mr-2 inline" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path>
                    </svg>
                    Orçamentos
                ...
                <button wire:click="setActiveTab('pagamentos')" 
                        class="{{ $activeTab === 'pagamentos' ? 'border-indigo-500 text-indigo-600 dark:text-indigo-400' : 'border-transparent text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300 hover:border-gray-300 dark:hover:border-gray-600' }} whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm">
                    <svg class="w-5 h-5 mr-2 inline" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1"></path>
                    </svg>
                    Pagamentos/Extrato
        ...
        <div class="p-6">
            ...
            @if($activeTab === 'visao-geral')
                <div>
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-lg shadow">
                        ...
                        <div class="p-6">
                            @if(!empty($timelineEventos) && count($timelineEventos) > 0)
                                <div class="flow-root">
                                    <ul role="list" class="-mb-8">
                                        @foreach($timelineEventos as $index => $evento)
                                            <li>
                                                <div class="relative pb-8">
                                                    @if($index < count($timelineEventos) - 1)
                                                        <span class="absolute top-4 left-4 -ml-px h-full w-0.5 bg-gray-200 dark:bg-gray-600" aria-hidden="true"></span>
                                                    @endif
                                                    <div class="relative flex space-x-3">
                                                        <div>
                                                            @if($evento['tipo'] === 'orcamento')
                                                            ...
                                                            <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-4">
                                                                <div class="flex items-start justify-between">
                                                                    <div class="flex-1">
                                                                        ...
                                                                        <p class="text-sm text-gray-600 dark:text-gray-300 mt-1">{{ $evento['descricao'] }}</p>
                                                                        
                                                                        @if(isset($evento['detalhes']))
                                                                        ...
                                                                        @if(isset($evento['status']))
                                                                            <div class="mt-2">
                                                                                <x-status-badge :status="$evento['status']" size="sm" />
                                                                            </div>
                                                                        @endif
                                                                    </div>
                                                                    <div class="text-right text-xs text-gray-500 dark:text-gray-400 ml-4">
                                                                        <time datetime="{{ $evento['data'] }}">{{ $evento['data']->format('d/m/Y') }}</time>
                                                                        @if(isset($evento['hora']))
                                                                            <br><span class="text-gray-400">{{ $evento['hora'] }}</span>
                                                                        @endif
                                                                    </div>
                                                                </div>
                                                            </div>
            ...
            @if($activeTab === 'orcamentos')
                <div>
                    ...
                    @if(!empty($orcamentosDetalhados) && count($orcamentosDetalhados) > 0)
                        <div class="overflow-x-auto">
                            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                                ...
                                <tbody>
                                    @foreach($orcamentosDetalhados as $orcamento)
                                        @php
                                        ...
                                        <tr class="border-b dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                            <td class="px-4 py-3 font-medium">
                                                <div class="flex flex-col">
                                                    <span class="font-bold text-gray-900 dark:text-gray-100">#{{ $orcamento->numero }}</span>
                                                    <span class="text-xs text-gray-500 dark:text-gray-400">{{ $orcamento->data_emissao ? $orcamento->data_emissao->format('d/m/Y') : 'N/A' }}</span>
                                                </div>
                                            </td>
                                            <td class="px-4 py-3">
                                                <div class="flex flex-col">
                                                    <span class="font-medium text-gray-900 dark:text-gray-100">{{ $orcamento->titulo }}</span>
                                                    @if($orcamento->data_validade)
                                                        <span class="text-xs {{ $orcamento->data_validade->isPast() ? 'text-red-500' : 'text-gray-500' }} dark:text-gray-400">
                                            ...
                                            <td class="px-4 py-3">{{ $orcamento->created_at->format('d/m/Y') }}</td>
                                            <td class="px-4 py-3 text-right font-medium">R$ {{ number_format($orcamento->valor_total, 2, ',', '.') }}</td>
                                            <td class="px-4 py-3 text-right text-green-600 dark:text-green-400">R$ {{ number_format($totalPago, 2, ',', '.') }}</td>
                                            <td class="px-4 py-3 text-right font-medium {{ $saldo > 0 ? 'text-red-600 dark:text-red-400' : 'text-green-600 dark:text-green-400' }}">
                                            ...
                                            <td class="px-4 py-3">
                                                <div class="flex items-center gap-2">
                                                    ...
                                                    @if($orcamento->status === 'Aprovado' && $saldo > 0)
            ...
            @if($activeTab === 'pagamentos')
                <div>
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6 mb-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                            <div class="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-lg">
                                ...
                                <div class="text-2xl font-bold text-blue-900 dark:text-blue-100">R$ {{ number_format($totalEmProjetos, 2, ',', '.') }}</div>
                            </div>
                            <div class="bg-green-50 dark:bg-green-900/20 p-4 rounded-lg">
                                <div class="text-sm font-medium text-green-600 dark:text-green-400">Total Pago</div>
                                <div class="text-2xl font-bold text-green-900 dark:text-green-100">R$ {{ number_format($totalPago, 2, ',', '.') }}</div>
                            </div>
                            <div class="bg-red-50 dark:bg-red-900/20 p-4 rounded-lg">
                                <div class="text-sm font-medium text-red-600 dark:text-red-400">Saldo Devedor</div>
                                <div class="text-2xl font-bold text-red-900 dark:text-red-100">R$ {{ number_format($saldoDevedor, 2, ',', '.') }}</div>
                            </div>
                            <div class="bg-purple-50 dark:bg-purple-900/20 p-4 rounded-lg">
                                <div class="text-sm font-medium text-purple-600 dark:text-purple-400">% Pago</div>
                                <div class="text-2xl font-bold text-purple-900 dark:text-purple-100">
                                    {{ $totalEmProjetos > 0 ? number_format(($totalPago / $totalEmProjetos) * 100, 1) : 0 }}%
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    {{-- Pagamentos Agrupados por Orçamento --}}
                    <div class="bg-white dark:bg-gray-800 rounded-lg shadow mb-6">
                                ...
                                @foreach($orcamentosDetalhados as $orcamento)
                                    ...
                                    <div class="accordion-item">
                                        ...
                                        <button type="button" 
                                                ...
                                                onclick="toggleAccordion('orcamento-{{ $orcamento->id }}')">
                                            <div class="flex items-center justify-between">
                                                <div class="flex-1">
                                                    <div class="flex items-center gap-4">
                                                        <div>
                                                            ...
                                                            <div class="flex items-center gap-4 mt-1">
                                                                <x-status-badge :status="$orcamento->status" size="sm" />
                                                        ...
                                                        <div class="flex items-center gap-6 text-sm">
                                                            ...
                                                            <div class="text-center">
                                                                ...
                                                                <div class="font-medium text-green-600 dark:text-green-400">
                                                                    R$ {{ number_format($totalPagoOrcamento, 2, ',', '.') }}
                                                                </div>
                                                            </div>
                                                            <div class="text-center">
                                                                <div class="text-gray-500 dark:text-gray-400">Saldo</div>
                                                                <div class="font-medium {{ $saldoOrcamento > 0 ? 'text-red-600 dark:text-red-400' : 'text-green-600 dark:text-green-400' }}">
                                                                    R$ {{ number_format($saldoOrcamento, 2, ',', '.') }}
                                                                </div>
                                                            </div>
                                                            <div class="text-center">
                                                                <div class="text-gray-500 dark:text-gray-400">% Pago</div>
                                                                <div class="font-medium text-gray-900 dark:text-gray-100">
                                                                    {{ number_format($percentualPago, 1) }}%
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="ml-4">
                                                    <svg class="w-5 h-5 text-gray-400 transform transition-transform duration-200 accordion-icon" 
                                                         id="icon-orcamento-{{ $orcamento->id }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        ...
                                        <div id="orcamento-{{ $orcamento->id }}" class="accordion-content hidden">
                                            <div class="px-6 pb-4">
                                                @if($orcamento->pagamentos && count($orcamento->pagamentos) > 0)
                                                    <div class="overflow-x-auto">
                                                            ...
                                                            <tbody class="divide-y divide-gray-100 dark:divide-gray-700">
                                                                @foreach($orcamento->pagamentos as $pagamento)
                                                                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-700">
                                                                        ...
                                                                        <td class="py-2 text-sm text-gray-900 dark:text-gray-100">
                                                                            {{ $pagamento->descricao ?? 'Pagamento do orçamento #' . $orcamento->numero }}
                                                                        </td>
                                    ...
                                    <tbody>
                                        @forelse($orcamentos as $orcamento)
                                            <tr class="border-b dark:border-gray-600">
                                                <td class="px-3 py-2 whitespace-nowrap">{{ optional($orcamento->updated_at)->format('d/m/Y') }}</td>
                                                <td class="px-3 py-2">{{ $orcamento->titulo }}</td>
                                                <td class="px-3 py-2 text-right whitespace-nowrap">R$ {{ number_format($orcamento->valor_total, 2, ',', '.') }}</td>
                                                @php
                                                    $faltaPagar = $orcamento->valor_total - $orcamento->pagamentos_sum_valor_pago;
                                                @endphp
                                                <td class="px-3 py-2 text-right font-bold whitespace-nowrap {{ $faltaPagar > 0 ? 'text-red-600 dark:text-red-400' : 'text-green-600 dark:text-green-400' }}">
                                ...
                                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                                    ...
                                    <tbody>
                                        @forelse($pagamentos as $pagamento)
                                            <tr class="border-b dark:border-gray-600">
                                                <td class="px-3 py-2 whitespace-nowrap">{{ optional($pagamento->data_pagamento)->format('d/m/Y') }}</td>
                                                <td class="px-3 py-2">Pagamento ref. Orçamento #{{ $pagamento->orcamento->numero }}</td>
                                                <td class="px-3 py-2 text-right text-green-600 dark:text-green-400 whitespace-nowrap">R$ {{ number_format($pagamento->valor_pago, 2, ',', '.') }}</td>
                                            </tr>
                                        @empty
                                            <tr>
