    ...
    <section class="py-20 bg-white">
        <div class="container mx-auto px-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="group cursor-pointer" wire:click="viewWork('{{ $work->slug }}')">
                ...
                <div class="flex flex-col lg:flex-row gap-4 items-center justify-between">
                    ...
                    <div class="flex flex-wrap gap-2">
                        <button wire:click="$set('selectedCategory', '')"
                                class="px-4 py-2 rounded-lg font-medium transition-colors {{ $selectedCategory === '' ? 'bg-blue-600 text-white' : 'bg-gray-100 text-gray-700 hover:bg-gray-200' }}">
                            Todos
                        </button>
                        @foreach($categories as $category)
                        <button wire:click="$set('selectedCategory', '{{ $category->id }}')"
                                class="px-4 py-2 rounded-lg font-medium transition-colors {{ $selectedCategory == $category->id ? 'bg-blue-600 text-white' : 'bg-gray-100 text-gray-700 hover:bg-gray-200' }}">
                            {{ $category->name }}
                        </button>
                        @endforeach
                    </div>
    ...
    <section id="contato" class="py-20 bg-blue-600">
        <div class="container mx-auto px-4 text-center">
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <a href="{{ route('about.public.index') }}" class="border-2 border-white text-white px-8 py-4 rounded-lg font-semibold hover:bg-white hover:text-blue-600 transition-colors">
                    Sobre Mim
                </a>
            </div>
        </div>
