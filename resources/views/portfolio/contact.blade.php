...
@section('title', 'Contato - Portfólio')
@section('description', 'Entre em contato para discutir seu próximo projeto. Estou sempre aberto a novos desafios e oportunidades de colaboração.')
            ...
            <div class="max-w-6xl mx-auto">
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-16">
                    ...
                    <div>
                        ...
                        <form action="{{ route('api.contact.store') }}" method="POST" class="space-y-6">
                            @csrf
                            ...
                            <div>
                                ...
                                <select id="subject" 
                                    ...
                                    <option value="ilustracao" {{ old('subject') == 'ilustracao' ? 'selected' : '' }}>Ilustração Digital</option>
                                    <option value="identidade" {{ old('subject') == 'identidade' ? 'selected' : '' }}>Identidade Visual</option>
                                    <option value="diagramacao" {{ old('subject') == 'diagramacao' ? 'selected' : '' }}>Diagramação</option>
                                    <option value="jogos" {{ old('subject') == 'jogos' ? 'selected' : '' }}>Design de Jogos</option>
                                    <option value="ui-ux" {{ old('subject') == 'ui-ux' ? 'selected' : '' }}>UI/UX Design</option>
                            ...
                            <div>
                                ...
                                <select id="budget" 
                                        name="budget"
                                        class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent @error('budget') border-red-500 @enderror">
                                    <option value="">Selecione uma faixa</option>
                                    <option value="500-1000" {{ old('budget') == '500-1000' ? 'selected' : '' }}>R$ 500 - R$ 1.000</option>
                                    <option value="1000-2500" {{ old('budget') == '1000-2500' ? 'selected' : '' }}>R$ 1.000 - R$ 2.500</option>
                                    <option value="2500-5000" {{ old('budget') == '2500-5000' ? 'selected' : '' }}>R$ 2.500 - R$ 5.000</option>
                                    <option value="5000-10000" {{ old('budget') == '5000-10000' ? 'selected' : '' }}>R$ 5.000 - R$ 10.000</option>
                                    <option value="10000+" {{ old('budget') == '10000+' ? 'selected' : '' }}>Acima de R$ 10.000</option>
                                    <option value="conversar" {{ old('budget') == 'conversar' ? 'selected' : '' }}>Prefiro conversar</option>
                                </select>
                                @error('budget')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
