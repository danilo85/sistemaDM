     ...
     <?php $__env->slot('header', null, []); ?> 
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
                <?php echo e(__('Categorias Financeiras')); ?>
                                    ...
                                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                        ...
                                        <td class="px-6 py-4 text-right">
                                            ...
                                            <div class="flex items-center justify-end gap-4">
                                                <a href="<?php echo e(route('categorias.edit', $categoria->id)); ?>" class="text-gray-500 hover:text-blue-600 dark:text-gray-400 dark:hover:text-blue-500" title="Editar">
                                                ...
                                                <form method="POST" action="<?php echo e(route('categorias.destroy', $categoria->id)); ?>" onsubmit="return confirm('Tem certeza que deseja excluir esta categoria?')">
                                                    <?php echo csrf_field(); ?>
