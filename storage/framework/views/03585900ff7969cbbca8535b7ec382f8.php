...
<?php $component->withAttributes([]); ?>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4 md:gap-6 mb-8 max-w-6xl mx-auto">
                    ...
                    <div class="p-4 md:p-6 pb-3 md:pb-4">
                        ...
                        <div class="block md:hidden">
                            ...
                            <div class="flex justify-center mb-3">
                                <div class="w-12 h-12 <?php if($categoria->tipo === 'receita'): ?> bg-green-100 dark:bg-green-900/30 <?php else: ?> bg-red-100 dark:bg-red-900/30 <?php endif; ?> flex items-center justify-center rounded-full">
                            ...
                            <div class="text-center mb-4">
                                ...
                                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium
                                    <?php if($categoria->tipo === 'receita'): ?> bg-green-100 text-green-800 dark:bg-green-900 dark:text-green-200
                                    <?php else: ?> bg-red-100 text-red-800 dark:bg-red-900 dark:text-red-200
                                    <?php endif; ?>">
                                    <?php echo e(ucfirst($categoria->tipo)); ?>
                            ...
                            <div class="flex justify-center mb-4">
                                <div class="flex items-center gap-4">
                                    ...
                                    <div class="flex-shrink-0">
                                        <div class="w-16 h-16 <?php if($categoria->tipo === 'receita'): ?> bg-green-100 dark:bg-green-900/30 <?php else: ?> bg-red-100 dark:bg-red-900/30 <?php endif; ?> flex items-center justify-center rounded-full border-2 border-white dark:border-gray-600">
                                            <?php if($categoria->tipo === 'receita'): ?>
                        ...
                        <div class="text-center space-y-4 mb-4">
                            ...
                            <div class="<?php if($categoria->tipo === 'receita'): ?> bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 border-green-200 dark:border-green-700 <?php else: ?> bg-gradient-to-r from-red-50 to-rose-50 dark:from-red-900/20 dark:to-rose-900/20 border-red-200 dark:border-red-700 <?php endif; ?> rounded-lg p-2 border">
                                ...
                                <div class="text-xl font-bold <?php if($categoria->tipo === 'receita'): ?> text-green-800 dark:text-green-200 <?php else: ?> text-red-800 dark:text-red-200 <?php endif; ?>">
                                    <?php echo e(ucfirst($categoria->tipo)); ?>
                        ...
                        <div class="px-4 pb-4">
                            <div class="flex items-stretch gap-2">
                                <a href="<?php echo e(route('categorias.edit', $categoria->id)); ?>" class="flex-1 bg-blue-100 hover:bg-blue-200 dark:bg-blue-900/30 dark:hover:bg-blue-900/50 text-blue-700 dark:text-blue-300 px-3 py-2 rounded-md text-xs font-medium text-center transition-colors flex flex-col items-center justify-center" title="Editar">
                                ...
                                <form method="POST" action="<?php echo e(route('categorias.destroy', $categoria->id)); ?>" onsubmit="return confirm('Tem certeza que deseja excluir esta categoria?')" class="flex-1">
                                    <?php echo csrf_field(); ?>
            ...
            <?php else: ?>
                <div class="text-center py-12">
                    ...
                    <div class="mt-6">
                        <a href="<?php echo e(route('categorias.create')); ?>" class="inline-flex items-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
    ...
    <a href="<?php echo e(route('categorias.create')); ?>" title="Nova Categoria"
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\sistemaDM\resources\views/admin/categorias/index.blade.php ENDPATH**/ ?>