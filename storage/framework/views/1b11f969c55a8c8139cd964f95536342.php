    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6 flex items-center gap-6">
            ...
            <div>
                ...
                <p class="text-2xl font-bold text-gray-900 dark:text-gray-100">R$ <?php echo e(number_format($faturamentoMes, 2, ',', '.')); ?></p>
            </div>
        </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6 flex items-center gap-6">
            ...
            <div>
                ...
                <p class="text-2xl font-bold text-gray-900 dark:text-gray-100">R$ <?php echo e(number_format($despesasMes, 2, ',', '.')); ?></p>
            </div>
        </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6 flex items-center gap-6">
            ...
            <div>
                ...
                <p class="text-2xl font-bold <?php echo e($saldoMes >= 0 ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400'); ?>">
                    R$ <?php echo e(number_format($saldoMes, 2, ',', '.')); ?>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6 flex items-center gap-6">
            ...
            <div>
                ...
                <p class="text-2xl font-bold text-gray-900 dark:text-gray-100">R$ <?php echo e(number_format($totalAReceber, 2, ',', '.')); ?></p>
            </div>
        </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6 flex items-center gap-6">
            ...
            <div>
                ...
                <p class="text-2xl font-bold text-gray-900 dark:text-gray-100"><?php echo e($orcamentosPendentes); ?></p>
            </div>
        </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6 flex items-center gap-6">
            ...
            <div>
                ...
                <p class="text-2xl font-bold text-gray-900 dark:text-gray-100"><?php echo e($projetosEmAndamento); ?></p>
            </div>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
            ...
            <ul class="divide-y divide-gray-200 dark:divide-gray-700">
                <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $orcamentosRecentes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $orcamento): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <li class="py-3">
                        <a href="<?php echo e(route('orcamentos.show', $orcamento)); ?>" class="flex justify-between items-center hover:bg-gray-50 dark:hover:bg-gray-700/50 p-2 rounded-lg -m-2">
                            <div>
                                <p class="font-medium text-gray-800 dark:text-gray-200"><?php echo e($orcamento->titulo); ?></p>
                                <p class="text-sm text-gray-500 dark:text-gray-400"><?php echo e($orcamento->cliente->name); ?></p>
                            </div>
                            <span class="text-sm font-mono text-gray-600 dark:text-gray-300">R$ <?php echo e(number_format($orcamento->valor_total, 2, ',', '.')); ?></span>
                        </a>
                    </li>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
            ...
            <ul class="divide-y divide-gray-200 dark:divide-gray-700">
                <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $transacoesRecentes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $transacao): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <li class="py-3">
                        <div class="flex justify-between items-center">
                            <div>
                                <p class="font-medium text-gray-800 dark:text-gray-200"><?php echo e($transacao->descricao); ?></p>
                                <p class="text-sm text-gray-500 dark:text-gray-400"><?php echo e($transacao->data->format('d/m/Y')); ?></p>
                            </div>
                            <span class="text-sm font-mono <?php echo e($transacao->tipo == 'receita' ? 'text-green-600' : 'text-red-600'); ?>">
...
<?php /**PATH C:\laragon\www\sistemaDM\resources\views/livewire/dashboard/dashboard-stats.blade.php ENDPATH**/ ?>