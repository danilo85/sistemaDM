...
<?php $component->withAttributes([]); ?>
                 <?php $__env->slot('title', null, []); ?> 
                    <div class="flex items-center gap-4">
                        <a href="<?php echo e(route('cartoes.index')); ?>" class="text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-white" title="Voltar">
...
[$__name, $__params] = $__split('cartao-form', [
                        'bandeirasDisponiveis' => $bandeirasDisponiveis
                    ]);

$__html = app('livewire')->mount($__name, $__params, 'lw-796535832-0', $__slots ?? [], get_defined_vars());
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\sistemaDM\resources\views/admin/cartoes/create.blade.php ENDPATH**/ ?>