...
<?php $component->withAttributes([]); ?>
    <div class="flex justify-center mb-4">
        <a href="/">
            <img src="<?php echo e(asset('images/logo_admin.png')); ?>" alt="Logo ADMIN" class="w-32 h-auto">
        </a>
    </div>
...
<?php endif; ?>
        ...
        <div class="flex items-center justify-end mt-4">
            ...
            <button type="submit" class="ml-4 inline-flex items-center justify-center px-4 py-2 text-sm font-semibold text-white bg-blue-600 rounded-lg hover:bg-blue-700">
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\sistemaDM\resources\views/auth/register.blade.php ENDPATH**/ ?>