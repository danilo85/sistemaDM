        ...
        <div class="flex justify-between items-center h-16">
            ...
            <div class="flex items-center">
                <a href="<?php echo e(route('dashboard')); ?>" class="flex items-center group">
                    <?php if(Auth::user()->logo_path): ?>
                        <img src="<?php echo e(asset('storage/' . Auth::user()->logo_path)); ?>" 
                             alt="Logo" 
            ...
            <nav class="hidden md:flex items-center space-x-1">
                ...
                <a href="<?php echo e(route('dashboard')); ?>" 
                   class="px-4 py-2 rounded-lg text-sm font-medium transition-all duration-200 hover:bg-gray-100 dark:hover:bg-gray-800 <?php echo e(request()->routeIs('dashboard') ? 'bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300' : 'text-gray-700 dark:text-gray-300'); ?>">
                    Dashboard
                </a>
                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('acessar_orcamentos')): ?>
                    <a href="<?php echo e(route('orcamentos.index')); ?>" 
                       class="px-4 py-2 rounded-lg text-sm font-medium transition-all duration-200 hover:bg-gray-100 dark:hover:bg-gray-800 <?php echo e(request()->routeIs('orcamentos.*') ? 'bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300' : 'text-gray-700 dark:text-gray-300'); ?>">
                        Orçamentos
                    </a>
                <?php endif; ?>
                ...
                <?php if(auth()->user()->can('acessar_clientes') || auth()->user()->can('acessar_autores') || auth()->user()->can('gerenciar_usuarios')): ?>
                    <div class="relative">
                        <button @click="toggleDropdown('gestao')" 
                                class="px-4 py-2 rounded-lg text-sm font-medium transition-all duration-200 hover:bg-gray-100 dark:hover:bg-gray-800 flex items-center space-x-1 <?php echo e(request()->routeIs(['admin.users.*', 'clientes.*', 'autores.*']) ? 'bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300' : 'text-gray-700 dark:text-gray-300'); ?>">
                            <span>Gestão</span>
                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('acessar_clientes')): ?>
                    <div class="relative">
                        <button @click="toggleDropdown('portfolio')" 
                                class="px-4 py-2 rounded-lg text-sm font-medium transition-all duration-200 hover:bg-gray-100 dark:hover:bg-gray-800 flex items-center space-x-1 <?php echo e(request()->routeIs(['portfolio.*', 'kanban.*']) ? 'bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300' : 'text-gray-700 dark:text-gray-300'); ?>">
                            <span>Portfólio</span>
                            <svg class="w-4 h-4 transition-transform duration-200" 
                        ...
                        <div x-show="activeDropdown === 'portfolio'" 
                            ...
                            <a href="<?php echo e(route('portfolio.pipeline.index')); ?>" 
                               class="flex items-center px-4 py-3 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors duration-150">
                                <svg class="w-5 h-5 mr-3 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('acessar_financeiro')): ?>
                    <div class="relative">
                        ...
                        <div x-show="activeDropdown === 'financeiro'" 
                            ...
                            <a href="<?php echo e(route('transacoes.index')); ?>" 
                               class="flex items-center px-4 py-3 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors duration-150">
                                <svg class="w-5 h-5 mr-3 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            ...
                            <a href="<?php echo e(route('bancos.index')); ?>" 
                               class="flex items-center px-4 py-3 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors duration-150">
                                <svg class="w-5 h-5 mr-3 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <a href="<?php echo e(route('profile.edit')); ?>" 
                   class="px-4 py-2 rounded-lg text-sm font-medium transition-all duration-200 hover:bg-gray-100 dark:hover:bg-gray-800 <?php echo e(request()->routeIs('profile.*') ? 'bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300' : 'text-gray-700 dark:text-gray-300'); ?>">
                    Perfil
                </a>
            </nav>
    ...
    <div x-show="mobileMenuOpen" 
        ...
        <div class="p-6 space-y-6">
            ...
            <div class="space-y-2">
                <a href="<?php echo e(route('dashboard')); ?>" 
                   @click="closeMobileMenu()"
                   class="flex items-center px-4 py-3 text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-lg transition-colors <?php echo e(request()->routeIs('dashboard') ? 'bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300' : ''); ?>">
                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('acessar_orcamentos')): ?>
                    <a href="<?php echo e(route('orcamentos.index')); ?>" 
                       @click="closeMobileMenu()"
                       class="flex items-center px-4 py-3 text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-lg transition-colors <?php echo e(request()->routeIs('orcamentos.*') ? 'bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300' : ''); ?>">
                        <svg class="w-5 h-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 7h6m0 10v-3m-3 3h.01M9 17h.01M9 14h.01M12 14h.01M15 11h.01M12 11h.01M9 11h.01M7 21h10a2 2 0 002-2V5a2 2 0 00-2-2H7a2 2 0 00-2 2v14a2 2 0 002 2z" />
                        </svg>
                        Orçamentos
...
</header><?php /**PATH C:\laragon\www\sistemaDM\resources\views/layouts/header.blade.php ENDPATH**/ ?>