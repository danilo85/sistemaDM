...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.money-input','data' => ['name' => 'valor_total','wire:model' => 'valor_total','id' => 'valor_total','class' => 'block w-full p-2.5 rounded-lg border-transparent bg-gray-100 dark:bg-gray-900 focus:ring-2 focus:ring-blue-500']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['name' => 'valor_total','wire:model' => 'valor_total','id' => 'valor_total','class' => 'block w-full p-2.5 rounded-lg border-transparent bg-gray-100 dark:bg-gray-900 focus:ring-2 focus:ring-blue-500']); ?>
...
<?php /**PATH C:\laragon\www\sistemaDM\resources\views/livewire/orcamento-edit-form.blade.php ENDPATH**/ ?>