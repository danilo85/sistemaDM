        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <form method="POST" action="<?php echo e(route('autores.update', $autor)); ?>" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        <?php echo method_field('PUT'); ?>
                        
                        <div class="space-y-6">
                            
                            <div x-data="{ logoPreview: '<?php echo e($autor->logo ? asset('storage/' . $autor->logo) : ''); ?>', dragging: false, handleFileSelect(event) { const file = event.target.files[0]; if (file) { this.logoPreview = URL.createObjectURL(file); } }, handleDrop(event) { const file = event.dataTransfer.files[0]; if (file) { document.getElementById('logo').files = event.dataTransfer.files; this.logoPreview = URL.createObjectURL(file); } } }">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <input id="name" name="name" type="text" class="block w-full p-2.5 rounded-lg border-transparent bg-gray-100 dark:bg-gray-900 focus:ring-2 focus:ring-blue-500" required autofocus value="<?php echo e(old('name', $autor->name)); ?>">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <input id="email" name="email" type="email" class="block w-full p-2.5 rounded-lg border-transparent bg-gray-100 dark:bg-gray-900 focus:ring-2 focus:ring-blue-500" value="<?php echo e(old('email', $autor->email)); ?>">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <input id="contact" name="contact" type="text" class="block w-full p-2.5 rounded-lg border-transparent bg-gray-100 dark:bg-gray-900 focus:ring-2 focus:ring-blue-500" value="<?php echo e(old('contact', $autor->contact)); ?>">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <textarea id="bio" name="bio" rows="4" class="block w-full p-2.5 rounded-lg border-transparent bg-gray-100 dark:bg-gray-900 focus:ring-2 focus:ring-blue-500" placeholder="Escreva uma breve biografia do autor..."><?php echo e(old('bio', $autor->bio)); ?></textarea>
                                <?php $__errorArgs = ['bio'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="flex items-center justify-end mt-6 pt-6 border-t border-gray-200 dark:border-gray-700 space-x-4">
                            <a href="<?php echo e(route('autores.index')); ?>" class="text-gray-900 bg-white border border-gray-300 focus:outline-none hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-gray-800 dark:text-white dark:border-gray-600 dark:hover:bg-gray-700 dark:hover:border-gray-600 dark:focus:ring-gray-700">
                                Voltar
                            </a>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\sistemaDM\resources\views/admin/autores/edit.blade.php ENDPATH**/ ?>