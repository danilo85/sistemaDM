...
<?php $__env->startSection('title', 'Serviços - Portfólio'); ?>
<?php $__env->startSection('description', 'Conheça os serviços de design que ofereço: ilustração digital, diagramação, design de jogos e muito mais.'); ?>
        ...
        <div class="container mx-auto px-4">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
                ...
                <div class="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow border border-gray-100">
                    ...
                    <p class="text-gray-600 leading-relaxed mb-6"><?php echo e($service->description); ?></p>
                    <a href="<?php echo e(route('contact.public.index')); ?>" class="inline-flex items-center text-blue-600 font-semibold hover:text-blue-700 transition-colors">
                        Solicitar Orçamento
    ...
    <section class="py-20 bg-blue-600">
        <div class="container mx-auto px-4 text-center">
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <a href="<?php echo e(route('portfolio.index')); ?>" class="border-2 border-white text-white px-8 py-4 rounded-lg font-semibold hover:bg-white hover:text-blue-600 transition-colors">
                    Ver Portfólio
                </a>
            </div>
        </div>
...
<?php echo $__env->make('layouts.portfolio', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\sistemaDM\resources\views/portfolio/services.blade.php ENDPATH**/ ?>