        ...
        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
            ...
            <tbody>
                <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $clientes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cliente): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr wire:key="<?php echo e($cliente->id); ?>" class="border-b bg-white dark:border-gray-700 dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-600">
                        <td class="px-6 py-4 font-medium text-gray-900 dark:text-white whitespace-nowrap">
                            <a href="<?php echo e(route('clientes.show', $cliente)); ?>" class="flex items-center gap-2 hover:underline dark:text-indigo-400">
                                <span><?php echo e($cliente->name); ?></span>
                        ...
                        <td class="px-6 py-4">
                            <!--[if BLOCK]><![endif]--><?php if($cliente->email): ?>
                                <a href="mailto:<?php echo e($cliente->email); ?>" class="text-gray-500 dark:text-gray-400 hover:text-indigo-600 dark:hover:text-indigo-400 hover:underline">
                        ...
                        <td class="px-6 py-4">
                            <!--[if BLOCK]><![endif]--><?php if($cliente->phone): ?>
                                <a href="https://wa.me/<?php echo e(preg_replace('/\D/', '', $cliente->phone)); ?>" target="_blank" class="text-gray-500 dark:text-gray-400 hover:text-indigo-600 dark:hover:text-indigo-400 hover:underline">
                        ...
                        <td class="px-6 py-4 text-right">
                           <div class="flex items-center justify-end gap-4">
                                <a href="<?php echo e(route('clientes.edit', $cliente->id)); ?>" class="text-gray-500 hover:text-blue-600 dark:text-gray-400 dark:hover:text-blue-500" title="Editar">
                                ...
                                <form method="POST" action="<?php echo e(route('clientes.destroy', $cliente->id)); ?>" onsubmit="return confirm('Tem certeza que deseja excluir este cliente?')">
                                    <?php echo csrf_field(); ?>
