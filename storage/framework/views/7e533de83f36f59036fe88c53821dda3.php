                    ...
                    <form method="POST" action="<?php echo e(route('categorias.store')); ?>">
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <input type="text" id="nome" name="nome" class="block w-full p-2.5 rounded-lg border-transparent bg-gray-100 dark:bg-gray-900 focus:ring-2 focus:ring-blue-500" placeholder="Ex: Salário, Supermercado" required value="<?php echo e(old('nome')); ?>">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <div class="grid grid-cols-2 gap-4">
                                    <div>
                                        <input type="radio" id="tipo-receita" name="tipo" value="receita" class="hidden peer" <?php echo e(old('tipo', 'despesa') == 'receita' ? 'checked' : ''); ?>>
                                    ...
                                    <div>
                                        <input type="radio" id="tipo-despesa" name="tipo" value="despesa" class="hidden peer" <?php echo e(old('tipo', 'despesa') == 'despesa' ? 'checked' : ''); ?>>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\sistemaDM\resources\views/admin/categorias/create.blade.php ENDPATH**/ ?>