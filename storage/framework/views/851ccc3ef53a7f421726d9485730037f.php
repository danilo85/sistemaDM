<div class="relative" x-data="{ open: <?php if ((object) ('showDropdown') instanceof \Livewire\WireDirective) : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('showDropdown'->value()); ?>')<?php echo e('showDropdown'->hasModifier('live') ? '.live' : ''); ?><?php else : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('showDropdown'); ?>')<?php endif; ?>, settings: <?php if ((object) ('showSettings') instanceof \Livewire\WireDirective) : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('showSettings'->value()); ?>')<?php echo e('showSettings'->hasModifier('live') ? '.live' : ''); ?><?php else : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('showSettings'); ?>')<?php endif; ?> }">
    ...
    >
        ...
        <div class="max-h-96 overflow-y-auto">
            <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $this->notifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="px-4 py-3 border-b border-gray-100 hover:bg-gray-50 transition-colors <?php echo e(!$notification['is_read'] ? 'bg-blue-50' : ''); ?>">
                    <div class="flex items-start space-x-3">
                        <!-- Ícone -->
                        <div class="flex-shrink-0 mt-1">
                            <div class="w-8 h-8 rounded-full bg-gray-100 flex items-center justify-center <?php echo e($this->getNotificationColor($notification['priority'])); ?>">
                                <?php
                                    $icon = $this->getNotificationIcon($notification['type']);
                                ?>
                                
                                <!--[if BLOCK]><![endif]--><?php if($icon === 'check-circle'): ?>
                                    <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                                        <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path>
                                    </svg>
                                <?php elseif($icon === 'x-circle'): ?>
                                    <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                        ...
                        <div class="flex-1 min-w-0">
                            <div class="flex items-center justify-between">
                                ...
                                <span class="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium <?php echo e($this->getPriorityBadgeClass($notification['priority'])); ?>">
                            ...
                            <div class="flex items-center justify-between mt-2">
                                <span class="text-xs text-gray-500"><?php echo e($this->getTimeAgo($notification['created_at'])); ?></span>
                                
                                <!-- Ações -->
                                <div class="flex items-center space-x-2">
                                    <!--[if BLOCK]><![endif]--><?php if($notification['budget_id']): ?>
                                        <button 
                                            wire:click="openBudget(<?php echo e($notification['id']); ?>, <?php echo e($notification['budget_id']); ?>)"
                                    ...
                                    <div class="relative" x-data="{ snoozeOpen: false }">
                                        ...
                                        >
                                            <div class="py-1">
                                                <button 
                                                    wire:click="snoozeNotification(<?php echo e($notification['id']); ?>, 1)"
                                                ...
                                                <button 
                                                    wire:click="snoozeNotification(<?php echo e($notification['id']); ?>, 24)"
                                                    @click="snoozeOpen = false"
                                                    class="block w-full text-left px-3 py-1 text-xs text-gray-700 hover:bg-gray-100"
                                                >
                                                    1 dia
                                                ...
                                                <button 
                                                    wire:click="snoozeNotification(<?php echo e($notification['id']); ?>, 168)"
                                                    @click="snoozeOpen = false"
                                                    class="block w-full text-left px-3 py-1 text-xs text-gray-700 hover:bg-gray-100"
                                                >
                                                    1 semana
        ...
        <!--[if BLOCK]><![endif]--><?php if($this->notifications->count() > 0): ?>
            <!-- Footer com paginação -->
            <div class="px-4 py-3 border-t border-gray-200 bg-gray-50">
                <div class="flex items-center justify-between">
                    <span class="text-xs text-gray-500">
                        Mostrando <?php echo e($this->notifications->count()); ?> de <?php echo e($totalNotifications); ?> notificações
                    </span>
                    
                    <!--[if BLOCK]><![endif]--><?php if($this->notifications->hasPages()): ?>
                        <div class="flex space-x-1">
                            <!--[if BLOCK]><![endif]--><?php if($this->notifications->onFirstPage()): ?>
                            ...
                            <!--[if BLOCK]><![endif]--><?php if($this->notifications->hasMorePages()): ?>
                                <button 
                                    wire:click="nextPage"
                                    class="px-2 py-1 text-xs text-blue-600 hover:text-blue-800"
                                >
...
</div><?php /**PATH C:\laragon\www\sistemaDM\resources\views/livewire/notification-bell.blade.php ENDPATH**/ ?>