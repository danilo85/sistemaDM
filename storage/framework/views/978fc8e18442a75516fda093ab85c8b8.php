                 ...
                 <?php $__env->slot('title', null, []); ?> 
                    <div>
                        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
                            <?php echo e(request('from') ? 'Copiando Orçamento' : 'Criar Novo Orçamento'); ?>
...
[$__name, $__params] = $__split('orcamento-create-form', ['fromOrcamentoId' => request('from')]);

$__html = app('livewire')->mount($__name, $__params, 'lw-2284117953-0', $__slots ?? [], get_defined_vars());
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\sistemaDM\resources\views/admin/orcamentos/create.blade.php ENDPATH**/ ?>