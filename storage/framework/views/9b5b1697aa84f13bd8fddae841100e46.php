...
<?php $__env->startSection('title', 'Sobre - Portfólio'); ?>
<?php $__env->startSection('description', 'Conheça minha trajetória como designer, experiências, habilidades e paixão por criar soluções visuais únicas.'); ?>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    <div>
                        ...
                        <div class="flex flex-col sm:flex-row gap-4">
                            <a href="<?php echo e(route('contact.public.index')); ?>" class="bg-blue-600 text-white px-8 py-4 rounded-lg font-semibold hover:bg-blue-700 transition-colors text-center">
                                Vamos Conversar
                            </a>
                            <a href="<?php echo e(route('portfolio.index')); ?>" class="border-2 border-gray-300 text-gray-700 px-8 py-4 rounded-lg font-semibold hover:border-gray-400 transition-colors text-center">
                                Ver Portfólio
                            </a>
                        </div>
                    </div>
    ...
    <section class="py-20 bg-blue-600">
        <div class="container mx-auto px-4 text-center">
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <a href="<?php echo e(route('services.public.index')); ?>" class="border-2 border-white text-white px-8 py-4 rounded-lg font-semibold hover:bg-white hover:text-blue-600 transition-colors">
                    Ver Serviços
                </a>
            </div>
        </div>
...
<?php echo $__env->make('layouts.portfolio', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\sistemaDM\resources\views/portfolio/about.blade.php ENDPATH**/ ?>