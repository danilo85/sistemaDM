...
>
    ...
    <div class="flex items-center justify-between">
        <a href="<?php echo e(route('dashboard')); ?>" class="focus:outline-none focus:ring-2 focus:ring-indigo-500 rounded">
            <?php if(Auth::user()->logo_path): ?>
                ...
                >
            <?php else: ?>
                <span class="text-lg font-bold text-gray-800 dark:text-gray-200"><?php echo e(config('app.name')); ?></span>
            <?php endif; ?>
        </a>
    ...
    <div class="mt-6 flex flex-1 flex-col justify-between">
        <nav class="-mx-3 space-y-6" role="navigation">
            ...
            <div class="space-y-2">
                <a
                    class="<?php echo e($linkBase); ?> <?php echo e(request()->routeIs('dashboard') ? $activeBg : ''); ?> px-3 py-2"
                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('acessar_orcamentos')): ?>
                    <a
                        class="<?php echo e($linkBase); ?> <?php echo e(request()->routeIs('orcamentos.*') ? $activeBg : ''); ?> px-3 py-2"
            ...
            <?php if(auth()->user()->can('acessar_clientes') || auth()->user()->can('acessar_autores') || auth()->user()->can('gerenciar_usuarios')): ?>
                <div class="space-y-2 border-t border-gray-200 dark:border-gray-700 pt-4">
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('gerenciar_usuarios')): ?>
                        <a
                            class="<?php echo e($linkBase); ?> <?php echo e(request()->routeIs('admin.users.*') ? $activeBg : ''); ?> px-3 py-2"
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('acessar_clientes')): ?>
                        <a
                            class="<?php echo e($linkBase); ?> <?php echo e(request()->routeIs('clientes.*') ? $activeBg : ''); ?> px-3 py-2"
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('acessar_autores')): ?>
                        <a
                            class="<?php echo e($linkBase); ?> <?php echo e(request()->routeIs('autores.*') ? $activeBg : ''); ?> px-3 py-2"
            ...
            <div class="space-y-2 border-t border-gray-200 dark:border-gray-700 pt-4">
                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('acessar_clientes')): ?>
                    ...
                    <a class="flex items-center rounded-lg text-gray-600 transition-colors duration-300 hover:bg-gray-100 hover:text-gray-700 dark:text-gray-200 dark:hover:bg-gray-700 <?php echo e(request()->routeIs('portfolio.pipeline.index') ? 'bg-gray-100 dark:bg-gray-700' : ''); ?> p-2" 
                    ...
                    <a class="flex items-center rounded-lg text-gray-600 transition-colors duration-300 hover:bg-gray-100 hover:text-gray-700 dark:text-gray-200 dark:hover:bg-gray-700 <?php echo e(request()->routeIs('kanban.index') ? 'bg-gray-100 dark:bg-gray-700' : ''); ?> p-2" 
                    href="<?php echo e(route('kanban.index')); ?>">
                    ...
                    <a class="flex items-center rounded-lg text-gray-600 transition-colors duration-300 hover:bg-gray-100 hover:text-gray-700 dark:text-gray-200 dark:hover:bg-gray-700 <?php echo e(request()->routeIs('portfolio.index') ? 'bg-gray-100 dark:bg-gray-700' : ''); ?> p-2" 
                    ...
                    <a class="flex items-center rounded-lg text-gray-600 transition-colors duration-300 hover:bg-gray-100 hover:text-gray-700 dark:text-gray-200 dark:hover:bg-gray-700 <?php echo e(request()->routeIs('portfolio.categories.index') ? 'bg-gray-100 dark:bg-gray-700' : ''); ?> p-2" 
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('acessar_financeiro')): ?>
                <div class="space-y-2 border-t border-gray-200 dark:border-gray-700 pt-4">
                    ...
                    <a class="<?php echo e($linkBase); ?> <?php echo e(request()->routeIs('transacoes.*') ? $activeBg : ''); ?> px-3 py-2"
                    ...
                    <a class="<?php echo e($linkBase); ?> <?php echo e(request()->routeIs('categorias.*') ? $activeBg : ''); ?> px-3 py-2"
                    ...
                    <a class="<?php echo e($linkBase); ?> <?php echo e(request()->routeIs('bancos.*') ? $activeBg : ''); ?> px-3 py-2"
                    ...
                    <a class="<?php echo e($linkBase); ?> <?php echo e(request()->routeIs('cartoes.*') ? $activeBg : ''); ?> px-3 py-2"
        ...
        <div class="space-y-2 border-t border-gray-200 dark:border-gray-700 pt-4">
            ...
            <a
                class="<?php echo e($linkBase); ?> <?php echo e(request()->routeIs('profile.*') ? $activeBg : ''); ?> px-3 py-2"
            ...
            <button
                ...
                class="<?php echo e($linkBase); ?> px-3 py-2"
            >
