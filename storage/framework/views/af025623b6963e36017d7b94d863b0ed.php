...
<?php $component->withAttributes([]); ?>
                 <?php $__env->slot('title', null, []); ?> 
                    <div class="flex items-center gap-4">
                        <a href="<?php echo e(route('categorias.index')); ?>" class="text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-white" title="Voltar">
        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 sm:p-8 text-gray-900 dark:text-gray-100">
                    ...
                    <form method="POST" action="<?php echo e(route('categorias.update', $categoria)); ?>">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <input type="text" id="nome" name="nome" class="block w-full p-2.5 rounded-lg border-transparent bg-gray-100 dark:bg-gray-900 focus:ring-2 focus:ring-blue-500" placeholder="Ex: Salário, Supermercado" required value="<?php echo e(old('nome', $categoria->nome)); ?>">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <div class="grid grid-cols-2 gap-4">
                                    <div>
                                        <input type="radio" id="tipo-receita" name="tipo" value="receita" class="hidden peer" <?php echo e(old('tipo', $categoria->tipo) == 'receita' ? 'checked' : ''); ?>>
                                    ...
                                    <div>
                                        <input type="radio" id="tipo-despesa" name="tipo" value="despesa" class="hidden peer" <?php echo e(old('tipo', $categoria->tipo) == 'despesa' ? 'checked' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="flex items-center justify-end mt-6 pt-6 border-t border-gray-200 dark:border-gray-700 space-x-4">
                            <a href="<?php echo e(route('categorias.index')); ?>" class="text-gray-900 bg-white border border-gray-300 focus:outline-none hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-gray-800 dark:text-white dark:border-gray-600 dark:hover:bg-gray-700 dark:hover:border-gray-600 dark:focus:ring-gray-700">
                                Cancelar
                            </a>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\sistemaDM\resources\views/admin/categorias/edit.blade.php ENDPATH**/ ?>