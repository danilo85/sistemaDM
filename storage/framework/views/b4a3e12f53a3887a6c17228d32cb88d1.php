     ...
     <?php $__env->slot('header', null, []); ?> 
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
                <?php echo e(__('Contas Bancárias')); ?>
                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <div class="relative overflow-x-auto">
                        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                            ...
                            <tbody>
                                <?php $__empty_1 = true; $__currentLoopData = $bancos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $banco): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                        <td class="px-6 py-4">
                                            <?php if($banco->logo_path): ?>
                                                <img src="<?php echo e($banco->logo_path); ?>" alt="Logo <?php echo e($banco->nome); ?>" class="h-10 object-contain full">
                                            <?php endif; ?>
                                        </td>
                                        ...
                                        <td class="px-6 py-4 capitalize">
                                            <?php echo e($banco->tipo_conta); ?>

                                        </td>
                                        
                                        <td class="px-6 py-4 text-right text-lg text-gray-600 dark:text-gray-400">
                                            <span class="whitespace-nowrap">R$ <?php echo e(number_format($banco->saldo_inicial, 2, ',', '.')); ?></span>
                                        </td>
                                        
                                        <td class="px-6 py-4 text-right text-xl font-bold <?php echo e($banco->saldo_atual >= 0 ? 'text-green-600' : 'text-red-600'); ?>">
                                            <span class="whitespace-nowrap">R$ <?php echo e(number_format($banco->saldo_atual, 2, ',', '.')); ?></span>
                                        </td>
                                        <td class="px-6 py-4 text-right">
                                            <div class="flex items-center justify-end gap-4">
                                                <a href="<?php echo e(route('bancos.edit', $banco->id)); ?>" class="text-gray-500 hover:text-blue-600 dark:text-gray-400 dark:hover:text-blue-500" title="Editar">
                                                ...
                                                <form method="POST" action="<?php echo e(route('bancos.destroy', $banco->id)); ?>" onsubmit="return confirm('Tem certeza que deseja excluir esta conta?')">
                                                    <?php echo csrf_field(); ?>
