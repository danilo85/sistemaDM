        ...
        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
            <thead class="bg-gray-50 text-xs uppercase text-gray-700 dark:bg-gray-700 dark:text-gray-400">
                <tr>
                    ...
                    <th scope="col" class="px-6 py-3 uppercase">Contato</th>
                    <th scope="col" class="px-6 py-3 text-right uppercase">Ações</th>
                </tr>
            </thead>
            <tbody>
                <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $autores; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $autor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr wire:key="<?php echo e($autor->id); ?>" class="border-b bg-white dark:border-gray-700 dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-600">
                        <td class="px-6 py-4 font-medium text-gray-900 dark:text-white whitespace-nowrap">
                            <a href="<?php echo e(route('autores.show', $autor)); ?>" class="flex items-center gap-2 hover:underline">
                                <span><?php echo e($autor->name); ?></span>
                        ...
                        <td class="px-6 py-4">
                            <!--[if BLOCK]><![endif]--><?php if($autor->email): ?>
                                <a href="mailto:<?php echo e($autor->email); ?>" class="text-gray-500 dark:text-gray-400 hover:text-indigo-600 dark:hover:text-indigo-400 hover:underline">
                        ...
                        <td class="px-6 py-4">
                            <!--[if BLOCK]><![endif]--><?php if($autor->contact): ?>
                                <a href="https://wa.me/<?php echo e(preg_replace('/\D/', '', $autor->contact)); ?>" target="_blank" class="text-gray-500 dark:text-gray-400 hover:text-indigo-600 dark:hover:text-indigo-400 hover:underline">
                        ...
                        <td class="px-6 py-4 text-right">
                           <div class="flex items-center justify-end gap-4">
                                <a href="<?php echo e(route('autores.edit', $autor->id)); ?>" class="text-gray-500 hover:text-blue-600 dark:text-gray-400 dark:hover:text-blue-500" title="Editar">
                                ...
                                <button 
                                    wire:click="deleteAutor(<?php echo e($autor->id); ?>)" 
                                    wire:confirm="Tem a certeza que deseja excluir este autor?" 
                ...
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                    <tr>
                        <td class="px-6 py-4 text-center" colspan="4">Nenhum autor encontrado.</td>
                    </tr>
                <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
            </tbody>
        </table>
...
<?php /**PATH C:\laragon\www\sistemaDM\resources\views/livewire/autor-list.blade.php ENDPATH**/ ?>