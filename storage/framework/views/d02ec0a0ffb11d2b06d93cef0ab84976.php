                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 overflow-hidden">
                            ...
                            <div class="flex items-center gap-3">
                                ...
                                <div class="flex-shrink-0">
                                    <?php if($cartao->bandeira_path): ?>
                                        <img src="<?php echo e($cartao->bandeira_path); ?>" alt="Bandeira" class="h-8 w-12 object-contain">
                                    <?php else: ?>
                                ...
                                <div class="flex-1 min-w-0">
                                    <h3 class="text-sm font-semibold text-gray-900 dark:text-white truncate"><?php echo e($cartao->nome); ?></h3>
                        ...
                        <div class="px-4 pb-4 space-y-3">
                            ...
                            <div class="bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 rounded-lg p-2">
                                ...
                                <div class="text-xl font-bold text-blue-800 dark:text-blue-200">
                                    R$ <?php echo e(number_format($cartao->limite_credito, 2, ',', '.')); ?>
                            ...
                            ?>
                            <div class="bg-gradient-to-r <?php echo e($isPositivo ? 'from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20' : 'from-red-50 to-rose-50 dark:from-red-900/20 dark:to-rose-900/20'); ?> rounded-lg p-2">
                                <div class="flex items-center gap-2 mb-1">
                                    <?php if($isPositivo): ?>
                                ...
                                <div class="text-xl font-bold <?php echo e($isPositivo ? 'text-green-800 dark:text-green-200' : 'text-red-800 dark:text-red-200'); ?>">
                                    R$ <?php echo e(number_format($saldoDisponivel, 2, ',', '.')); ?>
                        ...
                        <div class="px-4 pb-4">
                            <div class="grid grid-cols-2 gap-2 text-xs">
                                <div class="text-center p-2 bg-gray-50 dark:bg-gray-700 rounded">
                                    ...
                                    <div class="text-gray-900 dark:text-white font-semibold">Dia <?php echo e($cartao->dia_fechamento); ?></div>
                                </div>
                                <div class="text-center p-2 bg-gray-50 dark:bg-gray-700 rounded">
                                    <div class="font-medium text-gray-700 dark:text-gray-300">Vencimento</div>
                                    <div class="text-gray-900 dark:text-white font-semibold">Dia <?php echo e($cartao->dia_vencimento); ?></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="px-4 pb-4">
                            <div class="flex items-stretch gap-2">
                                <a href="<?php echo e(route('cartoes.extrato', $cartao->id)); ?>" class="flex-1 bg-green-100 hover:bg-green-200 dark:bg-green-900/30 dark:hover:bg-green-900/50 text-green-700 dark:text-green-300 px-3 py-2 rounded-md text-xs font-medium text-center transition-colors flex flex-col items-center justify-center" title="Extrato">
                                ...
                                <a href="<?php echo e(route('cartoes.edit', ['cartao' => $cartao->id])); ?>" class="flex-1 bg-blue-100 hover:bg-blue-200 dark:bg-blue-900/30 dark:hover:bg-blue-900/50 text-blue-700 dark:text-blue-300 px-3 py-2 rounded-md text-xs font-medium text-center transition-colors flex flex-col items-center justify-center" title="Editar">
                                ...
                                <form method="POST" action="<?php echo e(route('cartoes.destroy', ['cartao' => $cartao->id])); ?>" onsubmit="return confirm('Tem certeza que deseja excluir este cartão?')" class="flex-1">
                                    <?php echo csrf_field(); ?>
                ...
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                    <div class="col-span-full">
                        <div class="text-center py-12">
                            ...
                            <div class="mt-6">
                                <a href="<?php echo e(route('cartoes.create')); ?>" class="inline-flex items-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
