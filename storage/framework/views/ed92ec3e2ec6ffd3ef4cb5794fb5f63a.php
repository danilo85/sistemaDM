...
<?php $component->withAttributes([]); ?>
                 <?php $__env->slot('title', null, []); ?> 
                    <div class="flex items-center gap-4">
                        <a href="<?php echo e(url()->previous(route('transacoes.index'))); ?>" class="text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-white" title="Voltar">
                        ...
                        <h2 class="text-xl font-semibold leading-tight text-gray-800 dark:text-gray-200">
                            <?php echo e($transacao->exists ? 'Editar Lançamento' : 'Novo Lançamento'); ?>
...
[$__name, $__params] = $__split('transacao-form', [
                        'transacao' => $transacao,
...
$__html = app('livewire')->mount($__name, $__params, 'lw-1675961123-0', $__slots ?? [], get_defined_vars());
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\sistemaDM\resources\views/admin/transacoes/create.blade.php ENDPATH**/ ?>