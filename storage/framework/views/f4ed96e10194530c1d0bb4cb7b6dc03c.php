                ...
                <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                        <th scope="row" class="flex items-center px-6 py-4 text-gray-900 whitespace-nowrap dark:text-white">
                            <img class="h-10 object-contain" src="<?php echo e($user->logo_path ? asset('storage/' . $user->logo_path) : 'https://placehold.co/40x40/EBF4FF/7F9CF5?text=' . substr($user->name, 0, 1)); ?>" alt="<?php echo e($user->name); ?> logo">
                            <div class="pl-3">
                        ...
                        <td class="px-6 py-4 text-right">
                            <div class="flex items-center justify-end gap-2">
                                <button wire:click="openPermissionsModal(<?php echo e($user->id); ?>)" class="p-2 text-gray-500 rounded-lg hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-700" title="Gerir Permissões">
                                ...
                                <!--[if BLOCK]><![endif]--><?php if($user->id !== Auth::id()): ?>
                                    ...
                                    <button wire:click="openDeleteModal(<?php echo e($user->id); ?>)" class="p-2 text-gray-500 rounded-lg hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-700" title="Excluir">
    ...
    <!--[if BLOCK]><![endif]--><?php if($managingPermissionsForUser): ?>
        <div class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-xl w-full max-w-2xl" @click.away="$wire.closePermissionsModal()">
                <div class="p-6 border-b dark:border-gray-700"><h3 class="text-lg font-bold text-gray-900 dark:text-gray-100">Gerir Permissões para: <?php echo e($managingPermissionsForUser->name); ?></h3><p class="text-sm text-gray-600 dark:text-gray-400 mt-1">Selecione os módulos aos quais este usuário terá acesso.</p></div>
                <div class="p-6 max-h-[60vh] overflow-y-auto">
                    <div class="space-y-4">
                        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $allPermissions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $module => $permissions): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div>
                                <p class="font-semibold text-gray-700 dark:text-gray-300 capitalize"><?php echo e($module); ?></p>
                                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-2">
                                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $permissions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $permission): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <label class="flex items-center p-2 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700"><input type="checkbox" wire:model.live="userPermissions" value="<?php echo e($permission->name); ?>" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"><span class="ml-2 text-sm text-gray-600 dark:text-gray-400"><?php echo e(Str::replaceFirst('acessar_', '', $permission->name)); ?></span></label>
