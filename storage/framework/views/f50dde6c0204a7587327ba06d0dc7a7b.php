<div class="kanban-container" x-data="kanbanBoard()" x-init="init()">
    ...
    <div class="bg-white shadow-sm border-b border-gray-200 p-4 mb-6">
        <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
            ...
            <div class="flex items-center gap-6">
                ...
                <div class="flex items-center gap-4 text-sm">
                    <div class="flex items-center gap-2">
                        ...
                        <span class="text-gray-600"><?php echo e($metricas['total']); ?> trabalhos</span>
                    </div>
                    <div class="flex items-center gap-2">
                        <div class="w-3 h-3 bg-yellow-500 rounded-full"></div>
                        <span class="text-gray-600"><?php echo e($metricas['em_andamento']); ?> em andamento</span>
                    </div>
                    <div class="flex items-center gap-2">
                        <div class="w-3 h-3 bg-red-500 rounded-full"></div>
                        <span class="text-gray-600"><?php echo e($metricas['trabalhos_atrasados']); ?> atrasados</span>
                    </div>
                </div>
            </div>
            ...
            <div class="flex items-center gap-3">
                ...
                >
                    ...
                    <?php echo e($agrupadoPorCliente ? 'Agrupar por Status' : 'Agrupar por Cliente'); ?>
        ...
        <div class="mt-4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
            ...
            >
                ...
                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $responsaveis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $responsavel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($responsavel->id); ?>"><?php echo e($responsavel->name); ?></option>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><!--[if ENDBLOCK]><![endif]-->
            </select>
    ...
    <div class="relative">
        ...
        >
            ...
            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $statusColunas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status => $coluna): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="kanban-column bg-gray-50 rounded-lg p-4 min-w-80 max-w-80">
                    <!-- Header da Coluna -->
                    <div class="flex items-center justify-between mb-4">
                        <div class="flex items-center gap-2">
                            <div class="w-3 h-3 rounded-full" style="background-color: <?php echo e($coluna['cor']); ?>"></div>
                            <h3 class="font-semibold text-gray-900"><?php echo e($coluna['titulo']); ?></h3>
                            <span class="bg-gray-200 text-gray-700 text-xs px-2 py-1 rounded-full">
                                <?php echo e(count($trabalhosPorStatus[$status] ?? [])); ?>

                            </span>
                        </div>
                        
                        <!--[if BLOCK]><![endif]--><?php if($coluna['permite_adicionar'] ?? false): ?>
                    ...
                    <div 
                        ...
                        x-ref="column_<?php echo e($status); ?>"
                    >
                        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $trabalhosPorStatus[$status] ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $trabalho): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php
$__split = function ($name, $params = []) {
    return [$name, $params];
};
[$__name, $__params] = $__split('work-card', ['trabalho' => $trabalho]);

$__html = app('livewire')->mount($__name, $__params, 'work-card-' . $trabalho->id, $__slots ?? [], get_defined_vars());
...
?>
    ...
    >
        <div 
            ...
            @click.stop
        >
            <!--[if BLOCK]><![endif]--><?php if($trabalhoSelecionado): ?>
                <?php
$__split = function ($name, $params = []) {
    return [$name, $params];
};
[$__name, $__params] = $__split('work-modal', ['trabalhoId' => $trabalhoSelecionado]);

$__html = app('livewire')->mount($__name, $__params, 'work-modal-' . $trabalhoSelecionado, $__slots ?? [], get_defined_vars());
                ...
                const sortable = new Sortable(column, {
                    ...
                    onEnd: (evt) => {
                        ...
                        if (novoStatus !== statusAnterior) {
                            window.Livewire.find('<?php echo e($_instance->getId()); ?>').moverTrabalho(trabalhoId, novoStatus, novaPosicao).then(() => {
                            ...
                            window.Livewire.find('<?php echo e($_instance->getId()); ?>').atualizarPosicao(trabalhoId, novaPosicao).then(() => {
                                evt.item.style.opacity = '1';
                            }).catch(() => {
                                evt.item.style.opacity = '1';
                            });
...
<?php $__env->stopPush(); ?><?php /**PATH C:\laragon\www\sistemaDM\resources\views/livewire/kanban-board.blade.php ENDPATH**/ ?>